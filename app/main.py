...
# 1. CORS Middleware debe ser el primero en añadirse para procesar preflights correctamente
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
        "http://localhost:5173",
        "http://127.0.0.1:5173",
        "http://test.migbertweb.xyz",
        "https://test.migbertweb.xyz",
        "http://backend.migbertweb.xyz",
        "https://backend.migbertweb.xyz"
    ],
